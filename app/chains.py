...
"""
        ...
        try:
            ...
            raise OutputParserException(
                "Unable to extract jobs from the page."
            )
...
16. Do not infer skills, abilities, coursework, experience, or achievements from the fact that the candidate is a Computer Science graduate or from the job description. Mention only information explicitly provided in CANDIDATE INFORMATION or VERIFIED PORTFOLIO PROJECTS.
